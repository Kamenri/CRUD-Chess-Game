...
@WebServlet(name = "ReplayNextMoveServlet", urlPatterns = "/ReplayNextMove")
public class ReplayNextMoveServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        System.out.println("ReplyNextMove - doGet");
        ...
        try {
            ...
            //Gets the next move from the Move Query
            ArrayList<Game> temp = queryGamesClass.getReplayNextMove(gconnect,current_gameid,current_moveid);
